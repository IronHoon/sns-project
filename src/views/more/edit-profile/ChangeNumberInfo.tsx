...
import Icon from '../../../assets/img-change-num.svg';
import WhiteIcon from '../../../assets/img-change-num-white.svg';
...
function ChangeNumberInfo() {
  ...
  const handleConfirm = () => {
    modalClose();
    navigation.navigate('/phone-number-input', { route: 'change-number', update: update });
  };
    ...
    <MainLayout>
      ...
      <Container>
        ...
        <Desc>
          ...
          media, contacts, etc...{'\n'}
          will be moved to the new number.
        </Desc>
      </Container>
      <ButtonContainer>
        <Button
          ...
          label="Change number"
        >
          {themeContext.dark ? <WhitePhoneIcon width={24} height={24} /> : <PhoneIcon width={24} height={24} />}
        </Button>
      </ButtonContainer>
      ...
      <ContentModalBase isVisible={isModalOpen} onBackdropPress={modalClose}>
        ...
        <ModalText>
          User will see your new number if they have it in their address book or your privacy settings allow them to see
          it. You can modify this in{' '}
        </ModalText>
        <ModalText bold>Settings &gt; Privacy and Security &gt; Phone number.</ModalText>
        <ModalButtonContainer>
          ...
          <Button
            ...
            grayText
          />
          <Button onPress={handleConfirm} label="Continue" width={100} height={42} fontSize={13} />
        </ModalButtonContainer>
      </ContentModalBase>
    </MainLayout>
  );
