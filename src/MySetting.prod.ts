...
//   static readonly httpUrl: string = 'https://api.kokkokchat.link';
//   static readonly socketUrl: string = 'https://api.kokkokchat.link:2004';
// }
...
export default class MySetting {
  ...
  static readonly httpUrl: string = 'https://api.kokkokchat.link';
  static readonly socketUrl: string = 'wss://api.kokkokchat.link:2004';
