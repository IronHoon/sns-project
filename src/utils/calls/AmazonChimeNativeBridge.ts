...
//Native Module API calls and the event handler singleton.
...
export const MobileSDKEvent = {
  ...
  OnActiveSpeakerScore: 'OnActiveSpeakerScore',
...
export const NativeFunction = {
  ...
  setSpeakerOn: NativeModules.NativeMobileSDKBridge.setSpeakerOn,
