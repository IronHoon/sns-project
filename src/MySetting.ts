...
//   static readonly httpUrl: string = 'https://dev-api.kokkokchat.link';
//   static readonly socketUrl: string = 'https://dev-api.kokkokchat.link:2004';
// }
...
export default class MySetting {
  ...
  static readonly httpUrl: string = 'https://dev-api.kokkokchat.link';
  static readonly socketUrl: string = 'wss://dev-api.kokkokchat.link:2004';
  ...
  static readonly googleApiKey: string = 'anfnweriwernwenrwne';
}
